...
<html lang="en">
<head>
  <title>Login Cimanggung</title>
  <meta charset="UTF-8">
  <meta name="keyword" content="Kecamatan Cimanggung, Cimanggung, Portal Kecamatan Cimanggung, Web Kecamatan KalCimanggung">
  <meta name="description" content="Portal Resmi Kecamatan Cimanggung">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-form-title" style="background-image: url(<?php echo base_url() . 'assetss/images/kecamatan.png' ?>);">
        </div>
        ...
        <form class="login100-form validate-form" action="<?php echo site_url() . 'admin/login/auth' ?>" method="post">
          ...
          <div class="container-login100-form-btn">
            <button type="submit" class="login100-form-btn" name="login" type="login" value="login">
              Login
            </button>
          </div>
        </form>
