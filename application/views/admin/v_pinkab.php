...
foreach ($data->result_array() as $i):
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/pinkab/simpan_pinkab' ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_pindahkab; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       ...
                       <form class="form-horizontal" action="<?php echo base_url() . 'admin/pinkab/update_pinkab' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
 ...
 <?php foreach ($data->result_array() as $i):
  ...
  ?>
               ...
               <div class="modal fade" id="ModalHapus<?php echo $nomor_pindahkab; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                       <h4 class="modal-title" id="myModalLabel">Hapus jenis Pelayanan Pindah Kabupaten</h4>
                     </div>
                     <form class="form-horizontal" action="<?php echo base_url() . 'admin/pinkab/hapus_pinkab' ?>" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                        <input type="hidden" name="nomor_pindahkab" value="<?php echo $nomor_pindahkab; ?>"/>
                        <p>Apakah Anda yakin mau menghapus Jenis Pelayanan Pindah Kabupaten <b><?php echo $nama; ?></b> ?</p>
