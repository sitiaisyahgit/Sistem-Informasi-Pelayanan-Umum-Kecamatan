            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Jenis Pelayanan Pindah Kabupaten</a>
                  <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'pegawai/Laporankab' ?>"><span class="fa fa-print"></span> Cetak</a>
...
foreach ($data->result_array() as $i):
  $nomor_pindahkab = $i['nomor_pindahkab'];
  ...
  ?>
                                 <tr>
                                   ...
                                   <td><?php echo $nomor_pindahkab; ?></td>
                                   ...
                                   <td style="text-align:right;">
                                    <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $nomor_pindahkab; ?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn" data-toggle="modal" data-target="#ModalTampil<?php echo $nomor_pindahkab; ?>"><span class="fa fa-print"></span></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add Jenis Pelayanan Pindah Kabupaten</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/pinkab/simpan_pinkab' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xnomor_pindahkab" class="form-control" id="inputUserName" placeholder="Nomor" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xno_kk" class="form-control" id="inputUserName" placeholder="Nomor Kartu Keluarga" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xnama_kepala_kk" class="form-control" id="inputUserName" placeholder="Nama Kepala Keluarga" required>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label"> Alamat Sekarang</label>
                <div class="col-sm-7">
                  <input type="text" name="xalamat_sekarang" class="form-control" id="inputUserName" placeholder="Alamat Sekarang" required>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Alamat Tujuan</label>
                <div class="col-sm-7">
                  <input type="text" name="xalamat_tujuan" class="form-control" id="inputUserName" placeholder="Alamat Tujuan" required>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Jumlah Pindah</label>
                <div class="col-sm-7">
                  <input type="text" name="xjumlah_pindah" class="form-control" id="inputUserName" placeholder="Jumlah Pindah" required>
                </div>
              </div>
  ...
  ?>
                 <!--Modal Edit Pengguna-->
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_pindahkab; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       <div class="modal-header">
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                         <h4 class="modal-title" id="myModalLabel">Edit Jenis Pelayanan Pindah Kabupaten</h4>
                       </div>
                       <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/pinkab/update_pinkab' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                           ...
                           <div class="form-group">
                             <label for="inputUserName" class="col-sm-4 control-label">Nomor</label>
                             <div class="col-sm-7">
                              <input type="hidden" name="nomor_pindahkab" value="<?php echo $nomor_pindahkab; ?>"/>
                              <input type="text" name="xnomor_pindahkab" class="form-control" id="inputUserName" value="<?php echo $nomor_pindahkab; ?>" placeholder="Nomor" required>
                            </div>
                          </div>
                          <div class="form-group">
 ...
 <?php foreach ($data->result_array() as $i):
  ...
  $jumlah_pindah = $i['jumlah_pindah'];
  ?>
               <div class="modal fade" id="ModalTampil<?php echo $nomor_pindahkab; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                     ...
                     <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/pinkab/get_pinkab_byid' ?>" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                        <input type="hidden" name="nomor_pindahkab" value="<?php echo $nomor_pindahkab; ?>"/>
                          ...
                          <body>
                            <div id="wrapper">
                             <center>
                                 ...
                                 <p>Nomor : <?php echo $nomor_pindahkab; ?></p>
                             </center> 
                             <table border="0" class="table table-sm">
                                          ...
                                          <tr>
                                            <td colspan="3">
                                              <p> Demikian Surat Keterangan Pindah Kabupaten dibuat dan diberikan kepada pemohon untuk digunakan sebagaimana mestinya.</p></td>
                                          </tr>
                                         <tr align="right">
...
<?php if ($this->session->flashdata('msg') == 'error'): ?>
  ...
  <?php elseif ($this->session->flashdata('msg') == 'success'): ?>
    <script type="text/javascript">
      $.toast({
        heading: 'Success',
        text: "Jenis Pelayanan Pindah Kabupaten Berhasil disimpan ke database.",
        showHideTransition: 'slide',
        icon: 'success',
        hideAfter: false,
        position: 'bottom-right',
    ...
    <?php elseif ($this->session->flashdata('msg') == 'info'): ?>
      <script type="text/javascript">
        $.toast({
          heading: 'Info',
          text: "Jenis Pelayanan Pindah Kabupaten berhasil di update",
          showHideTransition: 'slide',
          icon: 'info',
          hideAfter: false,
          position: 'bottom-right',
      ...
      <?php elseif ($this->session->flashdata('msg') == 'success-hapus'): ?>
        <script type="text/javascript">
          $.toast({
            heading: 'Success',
            text: "Jenis Pelayanan Pindah Kabupaten Berhasil dihapus.",
            showHideTransition: 'slide',
            icon: 'success',
            hideAfter: false,
            position: 'bottom-right',
