            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Jenis Pelayanan Legalisasi</a>
                   <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'pegawai/Laporanlegalisasi' ?>"><span class="fa fa-print"></span> Cetak</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
foreach ($data->result_array() as $i):
  $nomor_legalisasi = $i['nomor_legalisasi'];
  ...
  ?>
                                 <tr>
                                   ...
                                   <td><?php echo $nomor_legalisasi; ?></td>
                                   ...
                                   <td style="text-align:right;">
                                    <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $nomor_legalisasi; ?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn" data-toggle="modal" data-target="#ModalTampil<?php echo $nomor_legalisasi; ?>"><span class="fa fa-print"></span></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add Jenis Legalisasi</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/legalisasi/simpan_legalisasi' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xnomor_legalisasi" class="form-control" id="inputUserName" placeholder="Nomor" required>
                </div>
              </div>
  ...
  ?>
                 <!--Modal Edit Pengguna-->
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_legalisasi; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       <div class="modal-header">
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                       ...
                       <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/legalisasi/update_legalisasi' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
                        ...
                        <div class="col-sm-7">
                          <input type="text" name="xid" class="form-control" id="inputUserName" placeholder="ID User" value="<?php echo $c['id']; ?> <?php echo $c['nama']; ?>"  readonly="readonly">
                           ...
                           <div class="form-group">
                             <label for="inputUserName" class="col-sm-4 control-label">Nomor</label>
                             <div class="col-sm-7">
                              <input type="hidden" name="nomor_legalisasi" value="<?php echo $nomor_legalisasi; ?>"/>
                              <input type="text" name="xnomor_legalisasi" class="form-control" id="inputUserName" value="<?php echo $nomor_legalisasi; ?>" placeholder="Nomor" required>
                            </div>
                          </div>
                          <div class="form-group">
 ...
 <?php foreach ($data->result_array() as $i):
  ...
  ?>
             <div class="modal fade" id="ModalTampil<?php echo $nomor_legalisasi; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                     ...
                     <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/legalisasi/get_legalisasi_byid' ?>" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                        <input type="hidden" name="nomor_legalisasi" value="<?php echo $nomor_legalisasi; ?>"/>
                          ...
                          <body>
                            <div id="wrapper">
                             <center>
                                 ...
                                 <p>Nomor : <?php echo $nomor_legalisasi; ?></p>
                             </center> 
