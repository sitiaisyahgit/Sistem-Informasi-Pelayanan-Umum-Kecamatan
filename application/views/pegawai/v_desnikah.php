  ...
  ?>
                                 <tr>
                                   ...
                                   <td style="text-align:right;">
                                    ...
                                    <a class="btn" data-toggle="modal" data-target="#ModalTampil<?php echo $nomor_desnikah; ?>"><span class="fa fa-print"></span></a>
                                  </td>
                                </tr>
                              <?php endforeach;?>
                </tbody>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/desnikah/simpan_desnikah' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xnomor_nk" class="form-control" id="inputUserName" placeholder="Nomor" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type='radio' name='xjenis_kelamin_pria' value="P" required> Perempuan<br>
                  <input type="radio" name="xjenis_kelamin_pria" value="L" required> Laki-laki<br>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <label for="inputUserName" class="col-sm-4 control-label">Jenis Kelamin</label>
                <div class="col-sm-7">
                  <input type='radio' name='xjenis_kelamin_pr' value="P" required> Perempuan<br>
                  <input type="radio" name="xjenis_kelamin_pr" value="L" required> Laki-laki<br>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Agama</label>
                 ...
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_desnikah; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       ...
                       <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/desnikah/update_desnikah' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-7">
                             <input type="date" name="xtanggal_buat" class="form-control" id="inputUserName" value="<?php echo $tanggal_buat; ?>" placeholder="Tanggal" required>
                           </div>
                         </div>
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Nama Pria</label>
                            <div class="col-sm-7">
                             <input type="text" name="xnama_pria" class="form-control" id="inputUserName" value="<?php echo $nama_pria; ?>" placeholder="Nama Pria" required>
                           </div>
                         </div>
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Tempat Lahir</label>
                            <div class="col-sm-7">
                             <input type="text" name="xtempat_tl_pria" class="form-control" id="inputUserName" value="<?php echo $tempat_tl_pria; ?>" placeholder="Tempat Lahir" required>
                           </div>
                         </div>
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Tanggal Lahir</label>
                            <div class="col-sm-7">
                             <input type="date" name="xtanggal_lahir_pria" class="form-control" id="inputUserName" value="<?php echo $tanggal_lahir_pria; ?>" placeholder="Tanggal Lahir" required>
                           </div>
                         </div>
                          <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Jenis Kelamin</label>
                         ...
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Agama</label>
                            <div class="col-sm-7">
                             <input type="text" name="xagama_pria" class="form-control" id="inputUserName" value="<?php echo $agama_pria; ?>" placeholder="Agama" required>
                           </div>
                         </div> 
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Status</label>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-7">
                             <input type="text" name="xnama_pr" class="form-control" id="inputUserName" value="<?php echo $nama_pr; ?>" placeholder="Nama Perempuan" required>
                           </div>
                         </div>
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Tempat Lahir</label>
                            <div class="col-sm-7">
                             <input type="text" name="xtempat_tl_pr" class="form-control" id="inputUserName" value="<?php echo $tempat_tl_pr; ?>" placeholder="Tempat Lahir" required>
                           </div>
                         </div>
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Tanggal Lahir</label>
                            <div class="col-sm-7">
                             <input type="date" name="xtanggal_lahir_pr" class="form-control" id="inputUserName" value="<?php echo $tanggal_lahir_pr; ?>" placeholder="Tanggal Lahir" required>
                           </div>
                         </div>
                          <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Jenis Kelamin</label>
                         ...
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Agama</label>
                            <div class="col-sm-7">
                             <input type="text" name="xagama_pr" class="form-control" id="inputUserName" value="<?php echo $agama_pr; ?>" placeholder="Agama" required>
                           </div>
                         </div> 
                         <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Status</label>
...
<?php foreach ($data->result_array() as $i):
  ...
  $status_pr = $i['status_pr'];
  ?>
                <div class="modal fade" id="ModalTampil<?php echo $nomor_desnikah; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                     ...
                     <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/desnikah/get_desnikah_byid' ?>" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                        <input type="hidden" name="nomor_desnikah" value="<?php echo $nomor_desnikah; ?>"/>
                          ...
                          <body>
                            <div id="wrapper">
                             <center>
                                 ...
                                 <p>Nomor : <?php echo $nomor_desnikah; ?></p>
                             </center> 
                             <table border="0" class="table table-sm">
                                          <tr>
                                            <td colspan="3"> 
                                              <p>Camat Cimanggung atas atas nama Bupati Jawa Barat dengan ini memberikan dispensasi bagi saudara : </p></td>
                                          ...
                                          <tr>
                                            <td colspan="3"> Yang akan melangsungkan pernikahan dengan : </td>
                                          </tr>
                                            <tr>
                                          ...
                                          <tr>
                                            <td colspan="3"><p>.</p>
                                              <p> Demikian Surat Keterangan ini dibuat untukmenjadikan malum kepada yang bersangkutan.</p></td>
                                          </tr>
                                         <tr align="right">
