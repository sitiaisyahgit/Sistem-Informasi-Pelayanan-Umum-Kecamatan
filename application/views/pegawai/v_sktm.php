...
foreach ($data->result_array() as $i):
  ...
  ?>
                                 <tr>
                                   ...
                                   <td style="text-align:right;">
                                    ...
                                    <a class="btn" data-toggle="modal" data-target="#ModalTampil<?php echo $nomor_sktm; ?>"><span class="fa fa-print"></span></a>
                                  </td>
                                </tr>
                              <?php endforeach;?>
                </tbody>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/sktm/simpan_sktm' ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_sktm; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       ...
                       <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/sktm/update_sktm' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
 ...
 <?php foreach ($data->result_array() as $i):
  ...
  ?>
               <div class="modal fade" id="ModalTampil<?php echo $nomor_sktm; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                          ...
                          <body>
                            <div id="wrapper">
                             ...
                             <table border="0" class="table table-sm">
                                          ...
                                          <tr>
                                            <td colspan="3"><p>Nama tersebut diatas adalah warga Kecamatan Cimanggung Kabupaten Sumedang. Berdasarkan keterangan yang ada pada kami benar bahwa yang bersangkutan tergolong keluarga yang tidak mampu.</p><br>
