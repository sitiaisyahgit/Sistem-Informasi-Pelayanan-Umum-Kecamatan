            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'pegawai/Laporankk' ?>"><span class="fa fa-print"></span> Cetak</a>
...
foreach ($data->result_array() as $i):
  ...
  ?>
                                 <tr>
                                   ...
                                   <td style="text-align:right;">
                                    <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $nomor_kk; ?>"><span class="fa fa-pencil"></span></a>
                                    <a class="btn" data-toggle="modal" data-target="#ModalTampil<?php echo $nomor_kk; ?>"><span class="fa fa-print"></span></a>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/kk/simpan_kk' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="xnomor_kk" class="form-control" id="inputUserName" placeholder="Nomor" required>
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-7">
                  <input type='radio' name='xjenkel' value="L" required> Laki-laki<br>
                  <input type="radio" name="xjenkel" value="P" required> Perempuan<br>
                  </div>
              </div>
              <div class="form-group">
  ...
  ?>
                 <!--Modal Edit Pengguna-->
                 <div class="modal fade" id="ModalEdit<?php echo $nomor_kk; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       <div class="modal-header">
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                       ...
                       <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/kk/update_kk' ?>" method="post" enctype="multipart/form-data">
                         <div class="modal-body">
                        ...
                        <div class="col-sm-7">
                          <input type="text" name="xid" class="form-control" id="inputUserName" placeholder="ID User" value="<?php echo $c['id']; ?> <?php echo $c['nama']; ?>"  readonly="readonly">
                           ...
                           <div class="form-group">
                             <label for="inputUserName" class="col-sm-4 control-label">Nomor</label>
                             <div class="col-sm-7">
                              <input type="hidden" name="nomor_kk" value="<?php echo $nomor_kk; ?>"/>
                              <input type="text" name="xnomor_kk" class="form-control" id="inputUserName" value="<?php echo $nomor_kk; ?>" placeholder="Nomor" required>
                            </div>
                          </div>
                          <div class="form-group">
 ...
 <?php foreach ($data->result_array() as $i):
  ...
  $alamat = $i['alamat'];
  ?>
               <div class="modal fade" id="ModalTampil<?php echo $nomor_kk; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                     ...
                     <form class="form-horizontal" action="<?php echo base_url() . 'pegawai/kk/get_kk_byid' ?>" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                        <input type="hidden" name="nomor_kk" value="<?php echo $nomor_kk; ?>"/>
                          ...
                          <body>
                            <div id="wrapper">
                             ...
                             <table border="0" class="table table-sm">
                                          ...
                                          <tr>
                                            <td colspan="3"><p>Akan melaksanakan pengajuan membuat Kartu Keluarga baru di Kecamatan Cimanggung.</p><br>
...
<?php if ($this->session->flashdata('msg') == 'error'): ?>
  ...
  <?php elseif ($this->session->flashdata('msg') == 'success'): ?>
    <script type="text/javascript">
      $.toast({
        heading: 'Success',
        text: "Jenis Pelayanan Perekaman Kartu Keluarga Berhasil disimpan ke database.",
        showHideTransition: 'slide',
        icon: 'success',
        hideAfter: false,
        position: 'bottom-right',
    ...
    <?php elseif ($this->session->flashdata('msg') == 'info'): ?>
      <script type="text/javascript">
        $.toast({
          heading: 'Info',
          text: "Jenis Pelayanan Perekaman Kartu Keluarga berhasil di update",
          showHideTransition: 'slide',
          icon: 'info',
          hideAfter: false,
          position: 'bottom-right',
      ...
      <?php elseif ($this->session->flashdata('msg') == 'success-hapus'): ?>
        <script type="text/javascript">
          $.toast({
            heading: 'Success',
            text: "Jenis Pelayanan Perekaman Kartu Keluarga Berhasil dihapus.",
            showHideTransition: 'slide',
            icon: 'success',
            hideAfter: false,
            position: 'bottom-right',
