<?php
Class Laporansktm extends CI_Controller{
    ...
    function index(){
        ...
        $pdf->Cell(400,10,'DAFTAR PELAYANAN SKTM',0,1,'C');
        // Memberikan space kebawah agar tidak terlalu rapat
        $pdf->Cell(20,7,'',0,1);
        $pdf->SetFont('Arial','B',14);
        $pdf->Cell(40,10,'NOMOR SKTM',1,0);
        ...
        $tbsktm = $this->db->get('tbsktm')->result();
        foreach ($tbsktm as $row){
            $pdf->Cell(40,10,$row->nomor_sktm,1,0);
