...
Class Laporanpdf extends CI_Controller{
    ...
    function index(){
        ...
        $pdf->Cell(400,10,'DAFTAR PELAYANAN E-KTP',0,1,'C');
        // Memberikan space kebawah agar tidak terlalu rapat
        $pdf->Cell(20,7,'',0,1);
        $pdf->SetFont('Arial','B',14);
        $pdf->Cell(32,10,'NOMOR KTP',1,0);
        ...
        $tbktp = $this->db->get('tbktp')->result();
        foreach ($tbktp as $row){
            $pdf->Cell(32,10,$row->nomor_ktp,1,0);
        ...
        $pdf->Cell(650,10,'OPERATOR KTP ELEKTRONIK',0,1,'C');
