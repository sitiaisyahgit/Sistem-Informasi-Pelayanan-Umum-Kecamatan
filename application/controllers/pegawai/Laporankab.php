<?php
Class Laporankab extends CI_Controller{
    ...
    function index(){
        ...
        $pdf->Cell(400,10,'DAFTAR PELAYANAN PINDAH KABUPATEN',0,1,'C');
        ...
        $tbktp = $this->db->get('tbpindahkab')->result();
        foreach ($tbktp as $row){
            $pdf->Cell(42,10,$row->nomor_pindahkab,1,0);
        ...
        $pdf->Cell(650,10,'OPERATOR PINDAH KABUPATEN',0,1,'C');
