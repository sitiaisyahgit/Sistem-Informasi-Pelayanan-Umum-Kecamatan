<?php
Class Laporankec extends CI_Controller{
    ...
    function index(){
        ...
        $pdf->Cell(400,10,'DAFTAR PELAYANAN PINDAH KECAMATAN',0,1,'C');
        ...
        $tbktp = $this->db->get('tbpindah')->result();
        foreach ($tbktp as $row){
            $pdf->Cell(42,10,$row->nomor_pindah,1,0);
        ...
        $pdf->Cell(650,10,'OPERATOR PINDAH KECAMATAN',0,1,'C');
