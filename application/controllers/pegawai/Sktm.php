...
class Sktm extends CI_Controller {
	...
	function index() {
		...
		$this->load->view('pegawai/v_sktm', $x);
	}
	...
	function hapus_sktm() {
		...
		$this->m_sktm->hapus_sktm($nomor);
		echo $this->session->set_flashdata('msg', 'success-hapus');
		redirect('pegawai/sktm');
	}
	function get_sktm_byid() {
		$nomor_sktm = strip_tags($this->input->post('xnomor_sktm'));
		$tanggal_buat = strip_tags($this->input->post('xtanggal_buat'));
		$nama = strip_tags($this->input->post('xnama'));
		$nik = strip_tags($this->input->post('xnik'));
		...
		$status_perkawinan = strip_tags($this->input->post('xstatus_perkawinan'));
		$alamat = strip_tags($this->input->post('xalamat'));
		$this->m_sktm->get_sktm_byid($nomor_sktm, $tanggal_buat, $nama, $nik, $jenis_kelamin, $tempat_tl, $tanggal_lahir, $warganegara, $agama, $pekerjaan, $status_perkawinan, $alamat);
		echo $this->session->set_flashdata('msg', 'success');
		redirect('pegawai/sktm');
	}
