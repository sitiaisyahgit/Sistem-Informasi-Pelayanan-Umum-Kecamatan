...
class Pindes extends CI_Controller {
	...
	function index() {
		...
		$this->load->view('admin/v_pindes', $x);
	}
	...
	function hapus_pindes() {
		$nomor_pindahdes = strip_tags($this->input->post('nomor_pindahdes'));
		$this->m_pindes->hapus_pindes($nomor_pindahdes);
